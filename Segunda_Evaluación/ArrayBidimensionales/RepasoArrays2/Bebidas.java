...
public class Bebidas {
	...
	public static void main(String[] args) throws IOException {
		...
		//Creamos el array a partir de los anteriores y le damos valores, en caso de que sea impar
		...
		do{
			...
			case 'R':
				break;
			case 'S': System.out.println("Salida!");continuar=false;
				break;
...
public static void MostrarBebidas(int[][]disponible,double[][]precios,String[][]bebidas) {
	...
	for (int k=0;k<bebidas.length;k++) {
		for (int m=0;m<bebidas[k].length;m++) {
			System.out.println(k+""+m+"  "+"("+disponible[k][m]+" disponibles) "+precios[k][m]+" euros "+bebidas[k][m]);
		}
	}
}
public static void PedirBebida(Scanner sc,double[][]disponible,String[][]bebidas) {
